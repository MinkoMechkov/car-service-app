  ...
  <div class="dashboard-container">
    ...
    <div class="welcome-section">
      <div class="welcome-content">
        ...
        <p class="welcome-subtitle">{{ $t('dashboard.todayOverview') }}</p>
      </div>
      <div class="quick-actions">
        <a-button type="primary" size="large" @click="router.push('/repairs/new')">
      ...
      <a-col :xs="24" :sm="12" :lg="6">
        <a-card class="stat-card stat-card-blue" :bordered="false">
          <div class="stat-content">
            ...
            <div class="stat-info">
              <p class="stat-label">{{ $t('dashboard.activeRepairs') }}</p>
      ...
      <a-col :xs="24" :sm="12" :lg="6">
        <a-card class="stat-card stat-card-green" :bordered="false">
          <div class="stat-content">
            ...
            <div class="stat-info">
              <p class="stat-label">{{ $t('dashboard.completedToday') }}</p>
      ...
      <a-col :xs="24" :sm="12" :lg="6">
        <a-card class="stat-card stat-card-orange" :bordered="false">
          <div class="stat-content">
            ...
            <div class="stat-info">
              <p class="stat-label">{{ $t('dashboard.totalClients') }}</p>
          ...
          >
            <template #bodyCell="{ column, record }">
              ...
              <template v-else-if="column.key === 'priority'">
                <a-badge :status="getPriorityStatus(record.priority)" :text="$t(`priority.${record.priority}`)" />
              </template>
        ...
        >
          ...
          <div class="chart-container">
            <div class="chart-placeholder">
              ...
              <p style="color: #999; margin-top: 16px;">{{ $t('dashboard.chartPlaceholder') }}</p>
            </div>
          </div>
        </a-card>
      </a-col>
