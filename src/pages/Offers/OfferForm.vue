...
import { useCreateOffer } from "@/api/offers/mutations";
import {
    SaveOutlined,
    CloseOutlined,
    PlusOutlined,
...
const loading = computed(() => createMutation.isPending.value);
...
const handleSubmit = async () => {
    try {
        ...
        message.error(t("offers.createError") || "Failed to create offer");
    }
};
